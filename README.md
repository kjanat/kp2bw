...
| `--include-oversize-secrets`           | Offload over-limit secret fields (hidden OTP secrets, passkey attributes) to a `.txt` attachment instead of dropping them (default: off) | `KP2BW_INCLUDE_OVERSIZE_SECRETS`      |
